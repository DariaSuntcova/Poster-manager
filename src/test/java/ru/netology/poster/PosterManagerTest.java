...
public class PosterManagerTest {
    ...
    Movie movie1 = new Movie("Пёс-самурай и город кошек", "анимация, комедия");
    Movie movie2 = new Movie("Одна", "драма, триллер");
    Movie movie3 = new Movie("Клаустрофобы. Долина дьявола", "хоррор");
    ...
    Movie movie7 = new Movie("Не звезди!", "комедия");
